...
| 5-character (25-bit) code space | ~33 million possible codes; brute-force possible offline | The 15-minute window limits usefulness of a found match |
...
| Encoding | RFC 4648 Base32 (custom implementation verified against stdlib) |
| Time window | 900-second epochs (Unix time ÷ 900, integer division) |
